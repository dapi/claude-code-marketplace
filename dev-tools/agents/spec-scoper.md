...
```
Безопасный лимит одной сессии:
- Суммарная сложность: до 3-4 L-задач или эквивалент
- Ориентир: ~50-80k токенов на код + контекст
- Запас на итерации: ~30-40%
```
  ...
  "breakdown": [
    {
      ...
      "depends_on": [],
      "recommendation": "in_scope_phase_1",
      "rationale": "Базовый слой, блокирует остальное"
    },
    {
      "id": "PART-002",
    ...
    },
    {
      ...
      "rationale": "Сложная интеграция, можно отложить"
    }
  ],
  "suggested_plan": {
    "session_1": ["PART-001"],
