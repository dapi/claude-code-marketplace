...
```
VERSION = "1.6.0"                # Версия команды (синхронизирована с frontmatter)
...
**Минимум 2 агента (обязательные), максимум 8 (все).**
...
| borderline, всё true | нужен breakdown | analyst, test, data, api, infra, risk, ux, **scoper** | 8 |
| too_large, всё true | нужен breakdown | analyst, test, data, api, infra, risk, ux, **scoper** | 8 |
...
### Фаза 1.5: Классификация + Quick Scope
- [ ] Запущен spec-classifier (haiku)
...
- [ ] Запущены 2 ОБЯЗАТЕЛЬНЫХ агента: spec-analyst, spec-test
- [ ] Запущены УСЛОВНЫЕ агенты по результатам classifier (0-6 агентов)
