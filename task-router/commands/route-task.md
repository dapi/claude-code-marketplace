...
Эта фаза вызывается ВМЕСТО обычных Фаз 4-6, когда классификатор определил `route = "needs-spec"`.
...
**Если выбрано "feature-dev" или "subagent-driven-dev"** — переходи к Фазе 6 с выбранным вариантом.
...
> Эта фаза только для `route = "feature-dev"` или `route = "subagent-driven-dev"`.
